...
/datum/uplink_item/device_tools/singularity_beacon
	name = "Power Beacon"
	desc = "When wrenched to exposed wiring attached to an electric grid and activated, this large device \
			pulls any active gravitational singularities or tesla balls towards it (provided they \
			are not safely contained), as well as increasing the odds of incoming meteor waves. \
